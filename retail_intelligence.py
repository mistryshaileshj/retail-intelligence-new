...
/* Deploy-proof text colors — don't rely on the deployed theme's textColor.
   (Fixes invisible Value/Quantity radio labels & the Sub Group value.) */
...
/* dropdown popover options (open list) also need dark text */
ul[data-baseweb="menu"] li,
li[role="option"]{{color:{TEXT_PRI} !important;}}
